 ...
 */
final class Version20211225163401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, isbn VARCHAR(255) NOT NULL, titre VARCHAR(255) NOT NULL, nbpages INT NOT NULL, date_de_parution DATE NOT NULL, note INT NOT NULL, UNIQUE INDEX UNIQ_AC634F99CC1CF4E6 (isbn), UNIQUE INDEX UNIQ_AC634F99FF7747B4 (titre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
